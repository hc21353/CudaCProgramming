...
int main(int argc, char *argv[])
{
    ...
    // INSERT CODE HERE
    cudaMemcpyToSymbol(M_c, M_h.elements, FILTER_SIZE*FILTER_SIZE*sizeof(M_h.elements[0]));
    ...
    dim_grid = dim3(ceil(imageWidth/(float)TILE_SIZE), ceil(imageHeight/(float)TILE_SIZE),1);
